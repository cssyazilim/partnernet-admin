...
$routes = [
    ...
    'invoices' => ['file' => __DIR__ . '/views/invoices.php', 'roles' => ['admin', 'super_admin', 'merkez', 'partner']],
    'addproduct'    => ['file' => __DIR__ . '/views/addproduct.php',    'roles' => ['admin', 'super_admin', 'merkez']],
